...
const features = [
  {
    "name": "Real-time Emotion Detection – Uses device camera to analyze facial expressions and infer emotional state.",
    "description": ""
  },
  {
    "name": "Contextual Data Integration – Incorporates location, weather, and calendar data for enhanced personalization.",
    "description": ""
  },
  {
    "name": "AI-Powered Playlist Generation – Generates dynamic playlists based on emotion, context, and listening history.",
    "description": ""
  },
  {
    "name": "Adaptive Learning – Continuously learns from user feedback (skips, likes) to improve playlist accuracy.",
    "description": ""
  },
  {
    "name": "Privacy Controls – Provides users with options to control data sharing and anonymize facial expression data.",
    "description": ""
  }
]
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="gradient-text">AI Music Curator</span>
            </h1>
