...
const features = [
  {
    "name": "Data Integration – Seamlessly connects to diverse data sources, including ERP systems, supply chain management platforms, logistics providers, and energy monitoring systems. Supports various data formats (CSV, Excel, APIs) and ensures data quality through automated validation and cleansing processes.",
    "description": ""
  },
  {
    "name": "AI-Driven Emission Analysis – Employs machine learning algorithms to analyze integrated data and identify emission hotspots. Detects patterns and anomalies indicative of high emission activities across the supply chain and internal operations. Provides granular insights into the environmental impact of specific products, suppliers, or processes.",
    "description": ""
  },
  {
  ...
  {
    "name": "Actionable Recommendations – Generates tailored recommendations for emission reduction strategies based on the AI-driven analysis. Suggests alternative materials, suppliers, or processes that can reduce the carbon footprint. Provides ROI estimates for different emission reduction initiatives.",
    "description": ""
  },
  {
    "name": "Reporting and Compliance – Automates the generation of sustainability reports that comply with industry standards and regulations (e.g., GRI, SASB, CDP). Tracks progress towards emission reduction targets and provides insights into the effectiveness of sustainability initiatives.",
    "description": ""
  }
]
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="gradient-text">AI-Powered Emission Hotspot Finder</span>
            </h1>
