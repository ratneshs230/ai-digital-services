...
const features = [
  {
    "name": "Personalized Recommendations – AI-driven suggestions based on browsing history, purchase history, and style preferences.",
    "description": ""
  },
  {
    "name": "Visual Search – Allows users to upload images of jewelry or luxury items to find similar products or complementary pieces.",
    "description": ""
  },
  {
    "name": "Style Matching – Identifies items that align with a user's stated style preferences (e.g., modern, classic, bohemian).",
    "description": ""
  },
  {
    "name": "Collaborative Filtering – Recommends products that are popular among users with similar tastes and preferences.",
    "description": ""
  },
  {
    "name": "Real-time Personalization – Adjusts recommendations based on current browsing behavior and interactions.",
    "description": ""
  }
]
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="gradient-text">AI-Powered Product Discovery</span>
            </h1>
