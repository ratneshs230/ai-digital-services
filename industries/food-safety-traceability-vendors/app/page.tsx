...
const features = [
  ...
  },
  {
    ...
    "description": "Employs machine learning algorithms to predict potential safety breaches based on historical data and real-time trends. This allows stakeholders to proactively address risks before they escalate, minimizing the impact on consumers and businesses. Time series forecasting and anomaly detection are used."
  },
  {
    "name": "Automated Alerting and Reporting",
    "description": "Generates automated alerts and reports based on detected anomalies and predicted risks. These alerts are customizable and can be delivered via email, SMS, or integrated into existing supply chain management systems. The reports provide detailed insights into the nature and severity of the anomalies, as well as recommended actions."
  },
  {
    "name": "Data Visualization Dashboard",
    "description": "Provides a user-friendly dashboard that visualizes real-time data, historical trends, and detected anomalies. The dashboard allows stakeholders to easily monitor the performance of the supply chain and identify potential areas of concern. Customizable charts and graphs are available."
  },
  {
    "name": "Supply Chain Mapping",
    "description": "Visualizes the entire supply chain from origin to consumer, providing a comprehensive overview of all stakeholders and processes involved. This allows for better tracking and tracing of food products, as well as improved coordination and communication among stakeholders."
  }
]
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="gradient-text">AI-Powered Anomaly Detection for Supply Chains</span>
            </h1>
