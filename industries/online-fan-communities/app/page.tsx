...
const features = [
  {
    ...
    "description": "Aggregates data from social media, forums, reviews, and news articles to provide an up-to-the-minute sentiment score."
  },
  {
    "name": "Trending Topic Identification",
    "description": "Uses NLP to identify and categorize trending topics, allowing users to understand what fans are talking about."
  },
  {
    "name": "Controversy Prediction",
    "description": "Employs machine learning to predict potential controversies based on sentiment shifts and trending topics."
  },
  {
    "name": "Customizable Dashboard",
    "description": "Offers a customizable dashboard to visualize sentiment data, trending topics, and potential controversies."
  },
  {
    "name": "Alerting System",
    "description": "Notifies users of significant sentiment changes or potential controversies in real-time."
  }
]
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="gradient-text">Fan Sentiment Analyzer</span>
            </h1>
