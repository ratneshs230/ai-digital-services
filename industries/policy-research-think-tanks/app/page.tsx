...
const features = [
  {
    ...
    "description": "** AI algorithms analyze data to identify emerging policy trends and predict their likelihood of occurrence, providing users with an early warning system for potential policy shifts. The models consider time-series data, event correlations, and sentiment analysis to generate probabilistic forecasts."
  },
  {
    "name": "**Impact Assessment",
    "description": "** The platform assesses the potential economic, social, and environmental impacts of predicted policy trends, enabling users to understand the consequences of policy changes and develop mitigation strategies. This includes quantitative modeling and scenario analysis."
  },
  {
  ...
  },
  {
    ...
    "description": "** Users can set up custom alerts to be notified of emerging policy trends that are relevant to their specific interests or areas of expertise, ensuring they stay informed of the latest developments."
  }
]
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="gradient-text">Policy Trend Forecaster</span>
            </h1>
