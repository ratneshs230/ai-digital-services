...
const features = [
  {
    "name": "Personalized Curriculum Recommendations",
    "description": "Analyzes student data to suggest optimal courses, modules, and learning materials."
  },
  {
    "name": "Performance Tracking",
    "description": "Monitors student progress and adjusts recommendations based on performance data."
  },
  {
    "name": "Learning Style Analysis",
    "description": "Identifies preferred learning styles (visual, auditory, kinesthetic) and recommends compatible resources."
  },
  {
    "name": "Career Path Integration",
    "description": "Aligns curriculum recommendations with student career aspirations and industry requirements."
  },
  {
    "name": "Knowledge Gap Identification",
    "description": "Pinpoints areas where students require additional support or remediation."
  }
]
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="gradient-text">AI-Powered Curriculum Recommendation Engine</span>
            </h1>
