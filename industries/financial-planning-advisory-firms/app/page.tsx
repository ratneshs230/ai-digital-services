...
const features = [
  {
    ...
    "description": "Seamlessly import client financial data from various sources."
  },
  {
    "name": "AI-Driven Plan Generation",
    "description": "Automatically generate personalized financial plans based on client data and market analysis."
  },
  {
    "name": "Investment Optimization",
    "description": "Recommend optimal investment allocations based on client risk tolerance and financial goals."
  },
  {
    "name": "Personalized Recommendations",
    "description": "Provide tailored savings, spending, and debt management advice."
  },
  {
    "name": "Market Trend Analysis",
    "description": "Incorporate real-time market data and economic forecasts into plan generation."
  },
  {
    "name": "Risk Assessment & Mitigation",
    "description": "Identify potential financial risks and provide strategies for mitigation."
  }
]
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="gradient-text">AI-Powered Financial Plan Personalization</span>
            </h1>
