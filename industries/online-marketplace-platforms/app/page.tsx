...
const features = [
  {
    ...
    "description": "Analyzes search queries and product descriptions to understand the underlying meaning and intent, delivering results that go beyond keyword matching."
  },
  {
    "name": "Personalized Product Recommendations",
    "description": "Dynamically recommends products based on individual user behavior, purchase history, browsing patterns, and stated preferences."
  },
  {
    "name": "Visual Similarity Search",
    "description": "Allows users to search for products using images, leveraging computer vision to identify visually similar items, even with vague descriptions."
  },
  {
    "name": "Attribute-Based Filtering",
    "description": "Enables granular filtering of products based on a wide range of attributes, such as style, material, color, size, price, and customer ratings."
  },
  {
    "name": "Real-time Optimization",
    "description": "Continuously learns from user interactions and feedback to refine the accuracy of product matching and recommendations."
  }
]
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="gradient-text">AI-Powered Product Matching</span>
            </h1>
