...
const features = [
  {
    ...
    "description": "Analyzes user data and external datasets to predict optimal property matches based on lifestyle, preferences, and future needs."
  },
  {
    "name": "Personalized Recommendations",
    "description": "Delivers highly relevant property listings tailored to individual user profiles and search history."
  },
  {
    "name": "Lifestyle Profiling",
    "description": "Captures user preferences related to schools, commute, amenities, architecture, and other lifestyle factors."
  },
  {
    "name": "Predictive Analysis",
    "description": "Forecasts future housing needs based on user demographics, life stage, and market trends."
  },
  {
    "name": "Interactive Map Interface",
    "description": "Provides a visually engaging way to explore property locations, nearby amenities, and neighborhood insights."
  }
]
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="gradient-text">AI-Powered Property Matchmaker</span>
            </h1>
