...
const features = [
  {
    ...
    "description": "AI-powered algorithm analyzes student performance data and generates a tailored study schedule."
  },
  {
    "name": "Dynamic Adjustment",
    "description": "Study plans automatically adjust based on the student's progress and performance on practice assessments."
  },
  {
    "name": "Knowledge Gap Identification",
    "description": "Identifies specific areas where the student needs improvement, ensuring focused study efforts."
  },
  {
    "name": "Progress Tracking",
    "description": "Visual dashboards and reports provide students with real-time insights into their progress and areas of strength and weakness."
  },
  {
    "name": "Resource Recommendation",
    "description": "Suggests relevant study materials, videos, and practice questions based on individual learning needs and the study plan."
  }
]
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="gradient-text">AI-Powered Personalized Study Plan Generator</span>
            </h1>
