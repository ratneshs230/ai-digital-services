...
const features = [
  {
    "name": "Brief Analysis",
    "description": "Upload client briefs (text, PDF, DOCX) and receive an immediate analysis report highlighting missing information, ambiguities, and potential areas for improvement. The system will parse the entire document, identifying key entities, relationships, and sentiment."
  },
  {
    "name": "Suggestion Engine",
    "description": "Provides AI-driven suggestions for improving brief clarity and completeness, including refined target audience definitions, suggested keywords based on product descriptions and industry trends, and alternative messaging approaches. The system recommends specific changes and provides rationale behind each suggestion."
  },
  {
  ...
  },
  {
    ...
    "description": "Integrates with leading SEO tools to suggest relevant keywords based on the brief's content, target audience, and industry trends. Provides keyword search volume, competition analysis, and long-tail keyword suggestions to improve search engine visibility."
  },
  {
    "name": "Collaboration Tools",
    "description": "Enables project managers and copywriters to collaborate on brief revisions within the platform, track changes, and communicate feedback directly on the analysis report. Supports version control and audit trails for accountability."
  }
]
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              <span className="gradient-text">AI-Powered Content Brief Analyzer</span>
            </h1>
